...
class InspServicos extends StatefulWidget {
  final Data data;
  final AppConfig dataConfig;

  InspServicos({this.data, this.dataConfig});

  @override
  _InspServicos createState() =>
      new _InspServicos(data: data, dataConfig: dataConfig);
}

enum SingingCharacter { conforme, naoConforme }

class _InspServicos extends State<InspServicos> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  final Data data;
  final AppConfig dataConfig;

  _InspServicos({this.data, this.dataConfig});
  ...
  Future<List<ModeloServicos>> _getModeloFVS() async {
    ...
    var data = await http.get('http://$_host:$_porta/GetItemMFVS/$_codFVS');
    var jsonData = json.decode(data.body)['ItensServicos'];
