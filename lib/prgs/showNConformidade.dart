...
class showNConformidade extends StatefulWidget {
  @override
  _showNConformidade createState() => new _showNConformidade();
}

class _showNConformidade extends State<showNConformidade> {
